...
export default function Home() {
  ...
  const [reportType,setReportType]=useState<"investment"|"projects"|"budget"|"pending"|"suppliers"|"delayed"|"progress">("investment");
