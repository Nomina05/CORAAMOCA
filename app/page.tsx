...
const institutionalDirections:InstitutionalDirection[]=[
 ...
 {name:"Dirección Administrativa y Financiera",shortName:"Administrativa y Financiera",icon:"$",area:"Financiera",modules:[{label:"Presupuesto y ejecución",section:"Proyectos Técnicos",icon:"$",permission:"ver_proyectos_tecnicos"},{label:"Compras, cuentas y proveedores",section:"Catálogos",icon:"▣",permission:"ver_catalogos"},{label:"Libramientos y pagos",section:"Cubicaciones",icon:"▧",permission:"ver_cubicaciones"}]},
    ...
    <div className="app-shell">
      ...
      <main>
        <header>
          ...
          <div className="header-actions"><button className="icon-btn" onClick={() => setNotice(0)}>♧{notice > 0 && <b>{notice}</b>}</button>{((section==="Cubicaciones"&&canView("registrar_cubicaciones"))||(section==="Proyectos Técnicos"&&canView("crear_proyectos_tecnicos"))||(!["Cubicaciones","Proyectos Técnicos"].includes(section)&&canView("crear_proyectos")))&&<button className="primary" onClick={() => section === "Cubicaciones" ? setShowMeasurementForm(true) : section === "Proyectos Técnicos" ? (setEditingTechnical(null),setShowTechnicalForm(true)) : setShowForm(true)}>＋ {section === "Cubicaciones" ? "Nueva cubicación" : "Nuevo proyecto"}</button>}</div>
        </header>
